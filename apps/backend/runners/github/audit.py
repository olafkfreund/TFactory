...
class AuditLogger:
    ...
    Usage:
        audit = AuditLogger(log_dir=Path(".tfactory/github/audit"))
    ...
    def __init__(
        ...
        Args:
            log_dir: Directory for audit logs (default: .tfactory/github/audit)
        ...
        """
        self.log_dir = log_dir or Path(".tfactory/github/audit")
