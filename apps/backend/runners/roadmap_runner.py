...
Usage:
    python tfactory/roadmap_runner.py --project /path/to/project
    python tfactory/roadmap_runner.py --project /path/to/project --refresh
    python tfactory/roadmap_runner.py --project /path/to/project --output roadmap.json
"""
...
def main():
    ...
    parser.add_argument(
        "--output",
        type=Path,
        help="Output directory for roadmap files (default: project/tfactory/roadmap)",
    )
    parser.add_argument(
        "--model",
        type=str,
