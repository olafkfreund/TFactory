...
class RoadmapOrchestrator:
    ...
    def __init__(
        ...
        # Default output to project's .tfactory directory (installed instance)
        # Note: tfactory/ is source code, .tfactory/ is the installed instance
        if output_dir:
            self.output_dir = Path(output_dir)
        else:
            # Initialize .tfactory directory and ensure it's in .gitignore
            init_magestic_ai_dir(self.project_dir)
            self.output_dir = self.project_dir / ".tfactory" / "roadmap"
