...
class FileEvolutionTracker:
    ...
    - File content snapshots in .tfactory/baselines/
    ...
    def __init__(
        ...
        Args:
            ...
            storage_dir: Directory for evolution data (default: .tfactory/)
        ...
        storage_dir = storage_dir or (self.project_dir / ".tfactory")
