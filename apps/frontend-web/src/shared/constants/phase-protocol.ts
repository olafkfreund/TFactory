...
export const EXECUTION_PHASES = [
  'idle',
  'spec_creation',  // Creating implementation plan/spec
  'planning',
  'plan_review',  // Paused for human plan approval
  'coding',
  'qa_review',
  'qa_fixing',
  'complete',
...
export const PHASE_ORDER_INDEX: Readonly<Record<ExecutionPhase, number>> = {
  idle: -1,
  spec_creation: -0.5,  // Between idle and planning
  planning: 0,
  plan_review: 0.5,  // Between planning and coding
  coding: 1,
  qa_review: 2,
  qa_fixing: 3,
  complete: 4,
