      ...
      {envConfig.graphitiEnabled && (
        <>
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              Name for the memory database (stored in ~/.tfactory/memories/)
            </p>
            <Input
              placeholder="tfactory_memory"
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              Custom storage location. Default: ~/.tfactory/memories/
            </p>
            <Input
              placeholder="~/.tfactory/memories"
