...
// Alternating tab colors - orange and magenta with light opacity
const TAB_COLORS = [
  'bg-orange-500/20 hover:bg-orange-500/30 border-b-orange-500',
  'bg-fuchsia-500/20 hover:bg-fuchsia-500/30 border-b-fuchsia-500',
];
