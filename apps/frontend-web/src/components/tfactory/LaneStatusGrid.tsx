...
> = {
  ...
  in_flight: {
    borderClass: 'border-info/40', bgClass: 'bg-info/10',
    iconColorClass: 'text-info', label: 'In flight',
  },
  success: {
    borderClass: 'border-success/40', bgClass: 'bg-success/10',
    iconColorClass: 'text-success', label: 'Complete',
  },
  warning: {
    borderClass: 'border-warning/40', bgClass: 'bg-warning/10',
    iconColorClass: 'text-warning', label: 'Needs review',
  },
  failure: {
    borderClass: 'border-destructive/40', bgClass: 'bg-destructive/10',
