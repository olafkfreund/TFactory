...
when_to_use: When the user wants to create or refresh a TFactory demo / screencast / showcase — a realistic over-the-shoulder recording of a developer handing a finished feature to TFactory and seeing tests generated, run, scored (pass AND fail), then merged or dismissed. Triggers — "/demo", "make a demo", "record a screencast", "showcase the handover", "demo the portal", "create a tfactory demo".
allowed-tools:
  - Bash
  - Read
  - Write
