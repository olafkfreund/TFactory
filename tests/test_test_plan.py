...
Tests the test_plan.py module functionality including:
...
class TestImplementationPlan:
    ...
    def test_plan_get_available_phases(self, sample_test_plan: dict):
        """Gets phases with satisfied dependencies."""
        plan = ImplementationPlan.from_dict(sample_test_plan)
    ...
    def test_plan_get_next_subtask(self, sample_test_plan: dict):
    ...
    def test_plan_get_progress(self, sample_test_plan: dict):
    ...
    def test_plan_save_and_load(self, temp_dir: Path, sample_test_plan: dict):
    ...
    def test_plan_to_dict(self, sample_test_plan: dict):
    ...
    def test_plan_from_dict(self, sample_test_plan: dict):
    ...
    def test_plan_status_summary(self, sample_test_plan: dict):
