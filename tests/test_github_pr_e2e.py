...
def temp_github_dir(tmp_path):
    ...
    github_dir = tmp_path / ".tfactory" / "github"
...
class TestBotDetectionE2E:
    ...
    def test_full_bot_detection_flow(self, tmp_path):
        ...
        with patch.object(BotDetector, "_get_bot_username", return_value="tfactory[bot]"):
        ...
        bot_pr = {"author": {"login": "tfactory[bot]"}}
        bot_commits = [{"author": {"login": "tfactory[bot]"}, "oid": "bot_commit"}]
